...
public class ApplicationContextSameBeanFindTest {
    ...
    void findBeanByTypDuplicate(){
        //SameBeanConfig에 동일한 빈이 두개있을때 돌리면 NoUniqueBean에러가 뜬다
    ...
    void findBeanByName(){
        ...
        assertThat(memberRepository).isNotInstanceOf(MemberRepository.class);
    }
    ...
    //동일한 타입이 둘이상일때 어떤게 발생하는지 알아보기 위한 설정빈
    @Configuration
